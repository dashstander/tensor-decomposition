"""Configuration for tensor decomposition training."""
...
class Config:
    ...
    seed: int
    data_dim: int      # dimension of each mode (complex)
    order: int         # number of copies of the vector space C^data_dim
    ...
    use_widely_linear: bool = True  # Use widely linear layers (more capacity) vs strictly linear
    use_wandb: bool = False  # Enable wandb logging
    wandb_project: str = "tensor-decomposition"  # Wandb project name
    ...
    s3_prefix: str = "tensor-decomposition"  # S3 key prefix
